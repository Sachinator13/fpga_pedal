...
module DE1_SoC_QSYS_mm_interconnect_0 (
	...
	wire   [26:0] data_in_s1_agent_m0_address;                                                        // data_in_s1_agent:m0_address -> data_in_s1_translator:uav_address
	...
	wire  [103:0] data_in_s1_agent_rf_source_data;                                                    // data_in_s1_agent:rf_source_data -> data_in_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] data_in_s1_agent_rsp_fifo_out_data;                                                 // data_in_s1_agent_rsp_fifo:out_data -> data_in_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> data_in_s1_agent:cp_valid
	wire  [102:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> data_in_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // data_in_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> data_in_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> data_in_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> data_in_s1_agent:cp_endofpacket
	...
	wire  [102:0] data_in_s1_agent_rp_data;                                                           // data_in_s1_agent:rp_data -> router_009:sink_data
	...
	wire          data_in_s1_agent_rdata_fifo_src_valid;                                              // data_in_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] data_in_s1_agent_rdata_fifo_src_data;                                               // data_in_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          data_in_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_007:in_0_ready -> data_in_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> data_in_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> data_in_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // data_in_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> data_in_s1_agent:rdata_fifo_sink_error
	...
	DE1_SoC_QSYS_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (pll_outclk0_clk),                                //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE1_SoC_QSYS_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (pll_outclk0_clk),                             //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
